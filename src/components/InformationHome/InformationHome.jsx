...
function InformationHome() {
  return (
    <div
      ...
      id="InromationHome"
    >
      <div className="max-w-6xl ml-10 py-10 px-5 relative w-full sm:flex justify-center items-center sm:ml-0">
        <div className="sm:pr-4 sm:flex sm:flex-col sm:justify-center sm:items-center lg:items-start">
          <h1 className="font-bold sm:text-[25px] lg:text-[35px]" style={{ color: "#f6b65f" }}>
            Agencia Gravity
          </h1>
          <p className="hidden text-white my-4 text-[16px] sm:block sm:text-center sm:w-[140px] lg:text-[19px] lg:w-[280px] lg:text-start">
          ...
          <p className="text-white text-[10px] w-[260px] mt-4 sm:hidden">
            ...
            estrategias de marketing y propuestas gráficas innovadoras.
          </p>
        ...
        <div
          ...
          style={{ borderLeft: "3px solid #f6b65f" }}
        >
