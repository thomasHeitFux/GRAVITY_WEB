    ...
    <>
      <div className="informationSection">
        ...
        <div className="information">
            ...
            identidades virtuales fuertes y efectivas. Gestionamos y
            diseñamos feeds de redes.
            <br/>
            La agencia gravity brinda servicios de diversas
            disciplinas con el objetivo de trabajar en equipo, haciendo de
            manera integral para el beneficio de sus clientes.
            </p>
