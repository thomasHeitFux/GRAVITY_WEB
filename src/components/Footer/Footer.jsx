  ...
  return (
    <div className="footerSection">
      ...
      <div className="footerSecondColumn">
        <h3 className="footerTitle"><strong>Redes Sociales</strong></h3>
        ...
        <h3 className="footerTitle"><strong>Correo Electrónico</strong></h3>
        <ul>
          <li> <a href="#"><img src={icon.Arrow_List} width="8px"/> Atencion@gravity.com</a> </li>
        </ul>
      </div>
      <div className="footerThirdColumn">
        <h3 className="footerTitle"><strong>Forma parte del equipo:</strong></h3>
        <ul>
          <li> <a href="#"><img src={icon.Arrow_List} width="8px"/> Postulate aquí</a> </li>
        </ul>
        <h3 className="footerTitle titleAliados"><strong>Aliados:</strong></h3>
        <img src="" alt=""/>
      </div>
        </div>
